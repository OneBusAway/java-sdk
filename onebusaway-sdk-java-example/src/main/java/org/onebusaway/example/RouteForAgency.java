...
public class RouteForAgency {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            RoutesForAgencyListParams params =
                    RoutesForAgencyListParams.builder().agencyId(agencyId).build();

            // Retrieve the routes for the agency
            RoutesForAgencyListResponse routesForAgency =
                    client.routesForAgency().list(params);

            for (RoutesForAgencyListResponse.Data.List route :
                    routesForAgency.data().list()) {
