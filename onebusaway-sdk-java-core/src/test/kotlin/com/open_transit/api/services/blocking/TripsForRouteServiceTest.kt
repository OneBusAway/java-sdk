...
import com.open_transit.api.services.blocking.TripsForRouteService
...
class TripsForRouteServiceTest {
    ...
    fun callList() {
      ...
      val tripsForRouteListResponse = tripsForRouteService.list(TripsForRouteListParams.builder()
          .routeId("routeID")
