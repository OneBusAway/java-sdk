...
import com.open_transit.api.services.blocking.ArrivalAndDepartureService
...
class ArrivalAndDepartureServiceTest {
    ...
    fun callRetrieve() {
      ...
      val arrivalAndDepartureRetrieveResponse = arrivalAndDepartureService.retrieve(ArrivalAndDepartureRetrieveParams.builder()
          .stopId("stopID")
          .serviceDate(123L)
          .tripId("tripId")
          .stopSequence(123L)
    ...
    fun callList() {
      val client = OnebusawaySdkOkHttpClient.builder()
          ...
          .build()
      val arrivalAndDepartureService = client.arrivalAndDeparture()
      val arrivalAndDepartureListResponse = arrivalAndDepartureService.list(ArrivalAndDepartureListParams.builder()
          .stopId("stopID")
          .minutesAfter(123L)
          .minutesBefore(123L)
