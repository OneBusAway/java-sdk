...
import com.open_transit.api.services.blocking.SearchForRouteService
...
class SearchForRouteServiceTest {
    ...
    fun callList() {
      ...
      val searchForRouteListResponse = searchForRouteService.list(SearchForRouteListParams.builder()
          .input("input")
          .maxCount(123L)
          .build())
