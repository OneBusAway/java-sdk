...
import com.open_transit.api.services.blocking.TripForVehicleService
...
class TripForVehicleServiceTest {
    ...
    fun callRetrieve() {
      ...
      val tripForVehicleRetrieveResponse = tripForVehicleService.retrieve(TripForVehicleRetrieveParams.builder()
          .vehicleId("vehicleID")
