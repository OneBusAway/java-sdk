...
import com.open_transit.api.services.blocking.RouteIdsForAgencyService
...
class RouteIdsForAgencyServiceTest {
    ...
    fun callList() {
      ...
      val routeIdsForAgencyListResponse = routeIdsForAgencyService.list(RouteIdsForAgencyListParams.builder()
          .agencyId("agencyID")
          .build())
