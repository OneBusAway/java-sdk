...
import com.open_transit.api.services.blocking.StopsForRouteService
...
class StopsForRouteServiceTest {
    ...
    fun callList() {
      ...
      val stopsForRouteListResponse = stopsForRouteService.list(StopsForRouteListParams.builder()
          .routeId("routeID")
