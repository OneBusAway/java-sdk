...
import com.open_transit.api.services.blocking.ScheduleForStopService
...
class ScheduleForStopServiceTest {
    ...
    fun callRetrieve() {
      ...
      val scheduleForStopRetrieveResponse = scheduleForStopService.retrieve(ScheduleForStopRetrieveParams.builder()
          .stopId("stopID")
