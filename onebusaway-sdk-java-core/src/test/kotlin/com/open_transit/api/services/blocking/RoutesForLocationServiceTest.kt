...
import com.open_transit.api.services.blocking.RoutesForLocationService
...
class RoutesForLocationServiceTest {
    ...
    fun callList() {
      ...
      val routesForLocationListResponse = routesForLocationService.list(RoutesForLocationListParams.builder()
          .lat(42.23)
          .lon(42.23)
          .latSpan(42.23)
          .lonSpan(42.23)
