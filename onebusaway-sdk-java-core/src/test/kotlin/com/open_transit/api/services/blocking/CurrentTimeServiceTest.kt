...
import com.open_transit.api.services.blocking.CurrentTimeService
...
class CurrentTimeServiceTest {
    ...
    fun callRetrieve() {
      ...
      val currentTimeRetrieveResponse = currentTimeService.retrieve(CurrentTimeRetrieveParams.builder().build())
