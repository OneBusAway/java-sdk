...
import com.open_transit.api.services.blocking.StopIdsForAgencyService
...
class StopIdsForAgencyServiceTest {
    ...
    fun callList() {
      ...
      val stopIdsForAgencyListResponse = stopIdsForAgencyService.list(StopIdsForAgencyListParams.builder()
          .agencyId("agencyID")
          .build())
