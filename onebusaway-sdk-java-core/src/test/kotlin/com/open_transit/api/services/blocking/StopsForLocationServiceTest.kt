...
import com.open_transit.api.services.blocking.StopsForLocationService
...
class StopsForLocationServiceTest {
    ...
    fun callList() {
      ...
      val stopsForLocationListResponse = stopsForLocationService.list(StopsForLocationListParams.builder()
          .lat(42.23)
          .lon(42.23)
          .latSpan(42.23)
          .lonSpan(42.23)
