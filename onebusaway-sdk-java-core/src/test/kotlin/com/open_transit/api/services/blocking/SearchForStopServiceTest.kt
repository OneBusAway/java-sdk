...
import com.open_transit.api.services.blocking.SearchForStopService
...
class SearchForStopServiceTest {
    ...
    fun callList() {
      ...
      val searchForStopListResponse = searchForStopService.list(SearchForStopListParams.builder()
          .input("input")
          .maxCount(123L)
          .build())
