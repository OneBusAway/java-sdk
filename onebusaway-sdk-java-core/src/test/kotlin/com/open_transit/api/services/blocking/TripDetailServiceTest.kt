...
import com.open_transit.api.services.blocking.TripDetailService
...
class TripDetailServiceTest {
    ...
    fun callRetrieve() {
      ...
      val tripDetailRetrieveResponse = tripDetailService.retrieve(TripDetailRetrieveParams.builder()
          .tripId("tripID")
