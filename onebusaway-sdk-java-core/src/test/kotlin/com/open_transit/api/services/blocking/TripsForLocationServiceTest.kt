...
import com.open_transit.api.services.blocking.TripsForLocationService
...
class TripsForLocationServiceTest {
    ...
    fun callList() {
      ...
      val tripsForLocationListResponse = tripsForLocationService.list(TripsForLocationListParams.builder()
          .lat(42.23)
          .latSpan(42.23)
          .lon(42.23)
          .lonSpan(42.23)
