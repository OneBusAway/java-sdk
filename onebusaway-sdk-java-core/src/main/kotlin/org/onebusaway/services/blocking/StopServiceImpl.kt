...
class StopServiceImpl internal constructor(private val clientOptions: ClientOptions) : StopService {
    ...
    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): StopService =
        StopServiceImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        override fun withOptions(
            ...
            StopServiceImpl.WithRawResponseImpl(
