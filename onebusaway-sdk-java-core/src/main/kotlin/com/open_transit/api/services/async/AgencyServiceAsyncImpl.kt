...
class AgencyServiceAsyncImpl constructor(private val clientOptions: ClientOptions, ) : AgencyServiceAsync {
    ...
    override fun retrieve(params: AgencyRetrieveParams, requestOptions: RequestOptions): CompletableFuture<AgencyRetrieveResponse> {
