...
class VehiclesForAgencyServiceAsyncImpl constructor(private val clientOptions: ClientOptions, ) : VehiclesForAgencyServiceAsync {
    ...
    override fun list(params: VehiclesForAgencyListParams, requestOptions: RequestOptions): CompletableFuture<VehiclesForAgencyListResponse> {
