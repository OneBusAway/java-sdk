...
class RoutesForAgencyServiceAsyncImpl constructor(private val clientOptions: ClientOptions, ) : RoutesForAgencyServiceAsync {
    ...
    override fun list(params: RoutesForAgencyListParams, requestOptions: RequestOptions): CompletableFuture<RoutesForAgencyListResponse> {
