...
class TripServiceAsyncImpl constructor(private val clientOptions: ClientOptions, ) : TripServiceAsync {
    ...
    override fun retrieve(params: TripRetrieveParams, requestOptions: RequestOptions): CompletableFuture<TripRetrieveResponse> {
