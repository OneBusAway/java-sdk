...
class TripForVehicleServiceAsyncImpl constructor(private val clientOptions: ClientOptions, ) : TripForVehicleServiceAsync {
    ...
    override fun retrieve(params: TripForVehicleRetrieveParams, requestOptions: RequestOptions): CompletableFuture<TripForVehicleRetrieveResponse> {
