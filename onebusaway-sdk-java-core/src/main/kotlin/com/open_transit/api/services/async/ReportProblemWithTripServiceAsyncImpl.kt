...
class ReportProblemWithTripServiceAsyncImpl constructor(private val clientOptions: ClientOptions, ) : ReportProblemWithTripServiceAsync {
    ...
    override fun retrieve(params: ReportProblemWithTripRetrieveParams, requestOptions: RequestOptions): CompletableFuture<ResponseWrapper> {
