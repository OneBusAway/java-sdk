...
class RouteIdsForAgencyServiceAsyncImpl constructor(private val clientOptions: ClientOptions, ) : RouteIdsForAgencyServiceAsync {
    ...
    override fun list(params: RouteIdsForAgencyListParams, requestOptions: RequestOptions): CompletableFuture<RouteIdsForAgencyListResponse> {
