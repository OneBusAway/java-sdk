...
class ScheduleForRouteServiceAsyncImpl constructor(private val clientOptions: ClientOptions, ) : ScheduleForRouteServiceAsync {
    ...
    override fun retrieve(params: ScheduleForRouteRetrieveParams, requestOptions: RequestOptions): CompletableFuture<ScheduleForRouteRetrieveResponse> {
