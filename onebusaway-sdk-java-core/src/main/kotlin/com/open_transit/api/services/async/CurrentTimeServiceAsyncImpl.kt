...
class CurrentTimeServiceAsyncImpl constructor(private val clientOptions: ClientOptions, ) : CurrentTimeServiceAsync {
    ...
    /** current-time */
    override fun retrieve(params: CurrentTimeRetrieveParams, requestOptions: RequestOptions): CompletableFuture<CurrentTimeRetrieveResponse> {
