...
class ReportProblemWithStopServiceAsyncImpl constructor(private val clientOptions: ClientOptions, ) : ReportProblemWithStopServiceAsync {
    ...
    override fun retrieve(params: ReportProblemWithStopRetrieveParams, requestOptions: RequestOptions): CompletableFuture<ResponseWrapper> {
