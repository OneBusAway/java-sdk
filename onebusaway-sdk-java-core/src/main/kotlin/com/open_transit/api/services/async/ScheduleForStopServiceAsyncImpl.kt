...
class ScheduleForStopServiceAsyncImpl constructor(private val clientOptions: ClientOptions, ) : ScheduleForStopServiceAsync {
    ...
    override fun retrieve(params: ScheduleForStopRetrieveParams, requestOptions: RequestOptions): CompletableFuture<ScheduleForStopRetrieveResponse> {
