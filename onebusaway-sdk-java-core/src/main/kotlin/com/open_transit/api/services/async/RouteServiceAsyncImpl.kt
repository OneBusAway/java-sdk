...
class RouteServiceAsyncImpl constructor(private val clientOptions: ClientOptions, ) : RouteServiceAsync {
    ...
    override fun retrieve(params: RouteRetrieveParams, requestOptions: RequestOptions): CompletableFuture<RouteRetrieveResponse> {
