...
class StopsForRouteServiceAsyncImpl constructor(private val clientOptions: ClientOptions, ) : StopsForRouteServiceAsync {
    ...
    override fun list(params: StopsForRouteListParams, requestOptions: RequestOptions): CompletableFuture<StopsForRouteListResponse> {
