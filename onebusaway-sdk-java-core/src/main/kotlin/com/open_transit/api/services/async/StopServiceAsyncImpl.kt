...
class StopServiceAsyncImpl constructor(private val clientOptions: ClientOptions, ) : StopServiceAsync {
    ...
    override fun retrieve(params: StopRetrieveParams, requestOptions: RequestOptions): CompletableFuture<StopRetrieveResponse> {
