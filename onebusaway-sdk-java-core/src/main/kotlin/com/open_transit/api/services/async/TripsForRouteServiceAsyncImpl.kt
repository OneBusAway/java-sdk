...
class TripsForRouteServiceAsyncImpl constructor(private val clientOptions: ClientOptions, ) : TripsForRouteServiceAsync {
    ...
    override fun list(params: TripsForRouteListParams, requestOptions: RequestOptions): CompletableFuture<TripsForRouteListResponse> {
