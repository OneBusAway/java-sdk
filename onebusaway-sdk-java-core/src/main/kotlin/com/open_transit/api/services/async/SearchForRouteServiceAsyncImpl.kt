...
class SearchForRouteServiceAsyncImpl constructor(private val clientOptions: ClientOptions, ) : SearchForRouteServiceAsync {
    ...
    override fun list(params: SearchForRouteListParams, requestOptions: RequestOptions): CompletableFuture<SearchForRouteListResponse> {
