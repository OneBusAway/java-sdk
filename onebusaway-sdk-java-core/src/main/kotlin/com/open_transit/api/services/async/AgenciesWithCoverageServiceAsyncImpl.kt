...
class AgenciesWithCoverageServiceAsyncImpl constructor(private val clientOptions: ClientOptions, ) : AgenciesWithCoverageServiceAsync {
     ...
     */
    override fun list(params: AgenciesWithCoverageListParams, requestOptions: RequestOptions): CompletableFuture<AgenciesWithCoverageListResponse> {
