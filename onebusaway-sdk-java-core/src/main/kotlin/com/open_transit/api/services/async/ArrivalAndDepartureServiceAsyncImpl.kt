...
class ArrivalAndDepartureServiceAsyncImpl constructor(private val clientOptions: ClientOptions, ) : ArrivalAndDepartureServiceAsync {
    ...
    override fun retrieve(params: ArrivalAndDepartureRetrieveParams, requestOptions: RequestOptions): CompletableFuture<ArrivalAndDepartureRetrieveResponse> {
    ...
    override fun list(params: ArrivalAndDepartureListParams, requestOptions: RequestOptions): CompletableFuture<ArrivalAndDepartureListResponse> {
      val request = HttpRequest.builder()
        .method(HttpMethod.GET)
