...
class SearchForStopServiceAsyncImpl constructor(private val clientOptions: ClientOptions, ) : SearchForStopServiceAsync {
    ...
    override fun list(params: SearchForStopListParams, requestOptions: RequestOptions): CompletableFuture<SearchForStopListResponse> {
