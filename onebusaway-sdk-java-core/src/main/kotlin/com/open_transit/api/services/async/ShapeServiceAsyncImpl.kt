...
class ShapeServiceAsyncImpl constructor(private val clientOptions: ClientOptions, ) : ShapeServiceAsync {
    ...
    override fun retrieve(params: ShapeRetrieveParams, requestOptions: RequestOptions): CompletableFuture<ShapeRetrieveResponse> {
