...
class TripDetailServiceAsyncImpl constructor(private val clientOptions: ClientOptions, ) : TripDetailServiceAsync {
    ...
    override fun retrieve(params: TripDetailRetrieveParams, requestOptions: RequestOptions): CompletableFuture<TripDetailRetrieveResponse> {
