...
class ScheduleForRouteRetrieveParams constructor(
  ...
  private val additionalHeaders: Map<String, List<String>>,
    ...
    override fun toString() = "ScheduleForRouteRetrieveParams{routeId=$routeId, date=$date, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders}"
    ...
    class Builder {
        ...
        fun build(): ScheduleForRouteRetrieveParams = ScheduleForRouteRetrieveParams(
