...
class RoutesForLocationListParams constructor(
  ...
  private val additionalHeaders: Map<String, List<String>>,
    ...
    override fun toString() = "RoutesForLocationListParams{lat=$lat, lon=$lon, latSpan=$latSpan, lonSpan=$lonSpan, query=$query, radius=$radius, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders}"
    ...
    class Builder {
        ...
        fun build(): RoutesForLocationListParams = RoutesForLocationListParams(
            checkNotNull(lat) {
