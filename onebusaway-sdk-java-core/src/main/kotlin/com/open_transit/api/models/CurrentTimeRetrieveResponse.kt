...
@NoAutoDetect
class CurrentTimeRetrieveResponse private constructor(
  ...
  private val additionalProperties: Map<String, JsonValue>,
    ...
    class Builder {
        ...
        fun build(): CurrentTimeRetrieveResponse = CurrentTimeRetrieveResponse(
            code,
            currentTime,
            text,
            version,
    ...
    class Data private constructor(private val entry: JsonField<Entry>, private val references: JsonField<References>, private val additionalProperties: Map<String, JsonValue>, ) {
        ...
        @NoAutoDetect
        class Entry private constructor(private val readableTime: JsonField<String>, private val time: JsonField<Long>, private val additionalProperties: Map<String, JsonValue>, ) {

            private var validated: Boolean = false

            private var hashCode: Int = 0

            fun readableTime(): Optional<String> = Optional.ofNullable(readableTime.getNullable("readableTime"))

            fun time(): Optional<Long> = Optional.ofNullable(time.getNullable("time"))

            @JsonProperty("readableTime")
            @ExcludeMissing
            fun _readableTime() = readableTime
            ...
            class Builder {
                ...
                @JsonProperty("time")
                @ExcludeMissing
                fun time(time: JsonField<Long>) = apply {
                    this.time = time
                }
