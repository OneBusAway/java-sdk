...
class ShapeRetrieveParams constructor(private val shapeId: String, private val additionalQueryParams: Map<String, List<String>>, private val additionalHeaders: Map<String, List<String>>, ) {
    ...
    override fun toString() = "ShapeRetrieveParams{shapeId=$shapeId, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders}"
    ...
    class Builder {
        ...
        fun shapeId(shapeId: String) = apply {
        ...
        fun build(): ShapeRetrieveParams = ShapeRetrieveParams(
            checkNotNull(shapeId) {
                "`shapeId` is required but was not set"
            },
