...
class SearchForStopListParams constructor(
  ...
  private val additionalHeaders: Map<String, List<String>>,
    ...
    override fun toString() = "SearchForStopListParams{input=$input, maxCount=$maxCount, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders}"
    ...
    class Builder {
        ...
        fun build(): SearchForStopListParams = SearchForStopListParams(
            checkNotNull(input) {
