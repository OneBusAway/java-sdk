...
class RouteRetrieveParams constructor(private val routeId: String, private val additionalQueryParams: Map<String, List<String>>, private val additionalHeaders: Map<String, List<String>>, ) {
    ...
    override fun toString() = "RouteRetrieveParams{routeId=$routeId, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders}"
    ...
    class Builder {
        ...
        fun build(): RouteRetrieveParams = RouteRetrieveParams(
