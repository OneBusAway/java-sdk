...
class BlockRetrieveParams constructor(private val blockId: String, private val additionalQueryParams: Map<String, List<String>>, private val additionalHeaders: Map<String, List<String>>, ) {
    ...
    override fun toString() = "BlockRetrieveParams{blockId=$blockId, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders}"
    ...
    class Builder {
        ...
        fun build(): BlockRetrieveParams = BlockRetrieveParams(
