...
@NoAutoDetect
class RoutesForLocationListResponse private constructor(
  ...
  private val additionalProperties: Map<String, JsonValue>,
    ...
    class Builder {
        ...
        fun build(): RoutesForLocationListResponse = RoutesForLocationListResponse(
            code,
            currentTime,
            text,
            version,
      ...
      private val additionalProperties: Map<String, JsonValue>,
        ...
        class List private constructor(
          ...
          private val additionalProperties: Map<String, JsonValue>,
            ...
            override fun toString() = "List{agencyId=$agencyId, color=$color, description=$description, id=$id, longName=$longName, nullSafeShortName=$nullSafeShortName, shortName=$shortName, textColor=$textColor, type=$type, url=$url, additionalProperties=$additionalProperties}"
