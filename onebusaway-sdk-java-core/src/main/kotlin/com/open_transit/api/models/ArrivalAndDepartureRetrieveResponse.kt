...
@NoAutoDetect
class ArrivalAndDepartureRetrieveResponse private constructor(
  ...
  private val additionalProperties: Map<String, JsonValue>,
    ...
    class Builder {
        ...
        @JvmSynthetic
        internal fun from(arrivalAndDepartureRetrieveResponse: ArrivalAndDepartureRetrieveResponse) = apply {
        ...
        fun build(): ArrivalAndDepartureRetrieveResponse = ArrivalAndDepartureRetrieveResponse(
            code,
            currentTime,
            text,
            version,
