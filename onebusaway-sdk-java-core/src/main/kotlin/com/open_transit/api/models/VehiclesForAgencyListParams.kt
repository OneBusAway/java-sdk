...
class VehiclesForAgencyListParams constructor(
  ...
  private val additionalHeaders: Map<String, List<String>>,
    ...
    override fun toString() = "VehiclesForAgencyListParams{agencyId=$agencyId, time=$time, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders}"
    ...
    class Builder {
        ...
        fun build(): VehiclesForAgencyListParams = VehiclesForAgencyListParams(
