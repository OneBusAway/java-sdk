...
@NoAutoDetect
class TripRetrieveResponse private constructor(
  ...
  private val additionalProperties: Map<String, JsonValue>,
    ...
    class Builder {
        ...
        fun build(): TripRetrieveResponse = TripRetrieveResponse(
            code,
            currentTime,
            text,
            version,
    ...
    class Data private constructor(private val entry: JsonField<Entry>, private val references: JsonField<References>, private val additionalProperties: Map<String, JsonValue>, ) {
        ...
        class Entry private constructor(
          ...
          private val additionalProperties: Map<String, JsonValue>,
            ...
            override fun toString() = "Entry{blockId=$blockId, directionId=$directionId, id=$id, peakOffpeak=$peakOffpeak, routeId=$routeId, routeShortName=$routeShortName, serviceId=$serviceId, shapeId=$shapeId, timeZone=$timeZone, tripHeadsign=$tripHeadsign, tripShortName=$tripShortName, additionalProperties=$additionalProperties}"
