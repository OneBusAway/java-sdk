...
class ArrivalAndDepartureRetrieveParams constructor(
  ...
  private val additionalHeaders: Map<String, List<String>>,
    ...
    internal fun getQueryParams(): Map<String, List<String>> {
      ...
      this.tripId.let {
          params.put("tripId", listOf(it.toString()))
      }
      this.stopSequence?.let {
          params.put("stopSequence", listOf(it.toString()))
      }
      this.time?.let {
    ...
    override fun toString() = "ArrivalAndDepartureRetrieveParams{stopId=$stopId, serviceDate=$serviceDate, tripId=$tripId, stopSequence=$stopSequence, time=$time, vehicleId=$vehicleId, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders}"
    ...
    class Builder {
        ...
        @JvmSynthetic
        internal fun from(arrivalAndDepartureRetrieveParams: ArrivalAndDepartureRetrieveParams) = apply {
        ...
        fun build(): ArrivalAndDepartureRetrieveParams = ArrivalAndDepartureRetrieveParams(
            checkNotNull(stopId) {
                "`stopId` is required but was not set"
            },
            checkNotNull(serviceDate) {
                "`serviceDate` is required but was not set"
            },
            checkNotNull(tripId) {
