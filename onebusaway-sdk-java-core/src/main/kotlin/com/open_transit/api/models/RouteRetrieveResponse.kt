...
@NoAutoDetect
class RouteRetrieveResponse private constructor(
  ...
  private val additionalProperties: Map<String, JsonValue>,
    ...
    class Builder {
        ...
        fun build(): RouteRetrieveResponse = RouteRetrieveResponse(
            code,
            currentTime,
            text,
            version,
    ...
    class Data private constructor(private val entry: JsonField<Entry>, private val references: JsonField<References>, private val additionalProperties: Map<String, JsonValue>, ) {
        ...
        class Entry private constructor(
          ...
          private val additionalProperties: Map<String, JsonValue>,
            ...
            override fun toString() = "Entry{agencyId=$agencyId, color=$color, description=$description, id=$id, longName=$longName, nullSafeShortName=$nullSafeShortName, shortName=$shortName, textColor=$textColor, type=$type, url=$url, additionalProperties=$additionalProperties}"
