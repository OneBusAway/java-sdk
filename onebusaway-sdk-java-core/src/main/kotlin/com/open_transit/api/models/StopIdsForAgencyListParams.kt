...
class StopIdsForAgencyListParams constructor(private val agencyId: String, private val additionalQueryParams: Map<String, List<String>>, private val additionalHeaders: Map<String, List<String>>, ) {
    ...
    override fun toString() = "StopIdsForAgencyListParams{agencyId=$agencyId, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders}"
    ...
    class Builder {
        ...
        fun build(): StopIdsForAgencyListParams = StopIdsForAgencyListParams(
