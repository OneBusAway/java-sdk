...
@NoAutoDetect
class VehiclesForAgencyListResponse private constructor(
  ...
  private val additionalProperties: Map<String, JsonValue>,
    ...
    class Builder {
        ...
        fun build(): VehiclesForAgencyListResponse = VehiclesForAgencyListResponse(
            code,
            currentTime,
            text,
            version,
    ...
    class Data private constructor(
      ...
      private val additionalProperties: Map<String, JsonValue>,
        ...
        override fun toString() = "Data{list=$list, limitExceeded=$limitExceeded, references=$references, additionalProperties=$additionalProperties}"
        ...
        class List private constructor(
          ...
          private val additionalProperties: Map<String, JsonValue>,
            ...
            fun occupancyCapacity(): Optional<Long> = Optional.ofNullable(occupancyCapacity.getNullable("occupancyCapacity"))

            fun occupancyCount(): Optional<Long> = Optional.ofNullable(occupancyCount.getNullable("occupancyCount"))
            ...
            @NoAutoDetect
            class Location private constructor(private val lat: JsonField<Double>, private val lon: JsonField<Double>, private val additionalProperties: Map<String, JsonValue>, ) {
