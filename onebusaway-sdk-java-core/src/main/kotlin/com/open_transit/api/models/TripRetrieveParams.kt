...
class TripRetrieveParams constructor(private val tripId: String, private val additionalQueryParams: Map<String, List<String>>, private val additionalHeaders: Map<String, List<String>>, ) {
    ...
    override fun toString() = "TripRetrieveParams{tripId=$tripId, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders}"
    ...
    class Builder {
        ...
        fun build(): TripRetrieveParams = TripRetrieveParams(
            checkNotNull(tripId) {
