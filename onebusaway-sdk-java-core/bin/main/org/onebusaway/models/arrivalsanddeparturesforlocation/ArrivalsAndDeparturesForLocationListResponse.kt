        ...
        private constructor(
            ...
            private constructor(
                ...
                fun occupancyStatus(): Optional<String> =
                    occupancyStatus.getOptional("occupancyStatus")
                ...
                fun scheduledTrack(): Optional<String> =
                    scheduledTrack.getOptional("scheduledTrack")
                ...
                private constructor(
                    ...
                    class Builder internal constructor() {
                        ...
                        /** Alias for calling [Builder.frequency] with `frequency.orElse(null)`. */
                        fun frequency(frequency: Optional<String>) =
            ...
            private constructor(
                 ...
                 *   type (e.g. if the server responded with an unexpected value).
                 */
                fun distanceFromQuery(): Optional<Double> =
                    distanceFromQuery.getOptional("distanceFromQuery")
                ...
                @JvmSynthetic
                internal fun validity(): Int =
                    (if (distanceFromQuery.asKnown().isPresent) 1 else 0) +
                        (if (stopId.asKnown().isPresent) 1 else 0)
