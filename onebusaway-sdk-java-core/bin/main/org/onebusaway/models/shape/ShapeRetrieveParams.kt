...
private constructor(
    ...
    fun shapeId(): Optional<String> = Optional.ofNullable(shapeId)
    ...
    companion object {
        ...
        @JvmStatic fun none(): ShapeRetrieveParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        /** Alias for calling [Builder.shapeId] with `shapeId.orElse(null)`. */
        fun shapeId(shapeId: Optional<String>) = shapeId(shapeId.getOrNull())
