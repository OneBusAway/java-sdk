...
class StopsForAgencyServiceImpl internal constructor(private val clientOptions: ClientOptions) :
    ...
    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): StopsForAgencyService =
        StopsForAgencyServiceImpl(clientOptions.toBuilder().apply(modifier::accept).build())
